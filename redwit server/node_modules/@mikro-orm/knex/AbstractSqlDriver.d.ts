...
export declare abstract class AbstractSqlDriver<C extends AbstractSqlConnection = AbstractSqlConnection> extends DatabaseDriver<C> {
    ...
    protected wrapVirtualExpressionInSubquery<T>(meta: EntityMetadata<T>, expression: string, where: FilterQuery<T>, options: FindOptions<T, any>): Promise<NonNullable<EntityData<T>>[]>;
    ...
    count<T extends AnyEntity<T>>(entityName: string, where: any, options?: CountOptions<T>): Promise<number>;
